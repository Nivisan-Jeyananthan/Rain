...
import ch.nivisan.rain.game.entity.mob.FlipState;
import ch.nivisan.rain.game.entity.mob.Mob;
import ch.nivisan.rain.game.entity.projectile.Projectile;
...
public class Screen {
	 ...
	 * top, left or right. Depending on if it will fit on the screen
	 *
	 * @param xStart
	 * @param yStart
	 * @param width
